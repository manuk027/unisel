        ...
        <header className="h-[10vh] min-h-[70px] flex items-center px-4 md:px-10 shrink-0 relative">
            ...
            <div className="w-full max-w-6xl mx-auto flex items-center justify-between bg-[#F8F9FC] px-6 md:px-10 py-2 rounded-full shadow-sm z-50">
                ...
                <nav className="hidden md:flex flex-grow justify-evenly items-center px-4 lg:px-8 text-gray-600 font-medium text-sm">
                    ...
                    <Link
                        to="/"
                        className="text-blue-600 border-b-2 border-blue-600 pb-1 flex items-center gap-2"
                    >
                    ...
                    <Link
                        to="/cart"
                        className="hover:text-blue-600 transition flex items-center gap-2 relative"
                    >
                        <i className="fa-solid fa-cart-shopping"></i>
                        Cart

                        <span className="absolute -top-2 -right-4 bg-blue-600 text-white text-[10px] w-4 h-4 rounded-full flex items-center justify-center">
                            2
                        </span>
                    </Link>
                </nav>
                ...
                <div className="flex items-center space-x-2 md:space-x-4 flex-shrink-0">
                    ...
                    {!token ? (
                        <div className="hidden md:flex items-center space-x-4">
                            ...
                            <Link
                                to="/login"
                                className="px-3 py-2 text-gray-700 hover:text-blue-600 font-medium flex items-center gap-2 transition text-sm"
                            >
                            ...
                            <Link
                                to="/signup"
                                className="px-5 py-2 bg-blue-600 text-white rounded-xl font-medium hover:bg-blue-700 transition shadow-md flex items-center gap-2 text-sm"
                            >
                ...
                <div className="absolute top-[85%] left-4 right-4 bg-white shadow-2xl rounded-3xl p-6 flex flex-col space-y-4 md:hidden z-[100] border border-gray-100 animate-in fade-in zoom-in duration-200">
                    ...
                    {!token ? (
                        <div className="flex flex-col space-y-3">
                            ...
                            <Link
                                to="/login"
                                className="w-full py-3 text-center text-gray-700 font-medium border border-gray-200 rounded-xl"
                            >
                                Login
                            </Link>
                            ...
                            <Link
                                to="/signup"
                                className="w-full py-3 text-center bg-blue-600 text-white font-medium rounded-xl shadow-lg shadow-blue-100"
                            >
                                Sign Up
                            </Link>
                        ...
                        <div className="flex flex-col space-y-4">
                            ...
                            <button
                                onClick={handleLogout}
                                className="w-full py-3 text-black font-medium border border-gray-200 rounded-xl"
                            >
                                Logout
                            </button>
