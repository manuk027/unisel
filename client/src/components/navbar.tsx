        ...
        <>
            <header className="hidden md:flex h-[10vh] min-h-[70px] items-center px-4 md:px-10 shrink-0 relative">
                <div className="w-full max-w-6xl mx-auto flex items-center justify-between bg-[#F8F9FC] px-6 md:px-10 py-2 rounded-full shadow-sm z-50">
                    <div className="flex-shrink-0">
                        <img
                            src={navLogo} alt="Unisel Logo" className="h-8 md:h-9 w-auto object-contain" />
                    </div>
                    ...
                    <nav className="hidden md:flex flex-grow justify-evenly items-center px-4 lg:px-8 text-gray-600 font-medium text-sm">
                        ...
                        <Link
                            to="/"
                            className={`flex items-center gap-2 pb-1 transition ${location.pathname === "/"
                        ...
                        <Link
                            to="/sell"
                            className={`flex items-center gap-2 pb-1 transition ${location.pathname === "/sell"
                                    ? "text-blue-600 border-b-2 border-blue-600"
                                    : "hover:text-blue-600"
                                }`}
                        >
                        ...
                        <Link
                            to="/buy"
                            className={`flex items-center gap-2 pb-1 transition ${location.pathname === "/buy"
                                    ? "text-blue-600 border-b-2 border-blue-600"
                                    : "hover:text-blue-600"
                                }`}
                        >
                        ...
                        <Link
                            to="/my-products"
                            className={`flex items-center gap-2 pb-1 transition ${location.pathname === "/my-products"
                                    ? "text-blue-600 border-b-2 border-blue-600"
                                    : "hover:text-blue-600"
                                }`}
                        >
                        ...
                        <Link
                            to="/cart"
                            className={`flex items-center gap-2 pb-1 transition ${location.pathname === "/cart"
                                    ? "text-blue-600 border-b-2 border-blue-600"
                                    : "hover:text-blue-600"
                                }`}
                        >
            ...
            <div className="md:hidden fixed bottom-4 left-4 right-4 z-[100]">
                ...
                <div className="bg-white border border-gray-100 shadow-2xl rounded-3xl px-6 py-3 flex items-center justify-between">
                    ...
                    <Link
                        to="/sell"
                        className={`flex flex-col items-center text-xs ${location.pathname === "/sell"
                                ? "text-blue-600"
                                : "text-gray-500"
                            }`}
                    >
                    ...
                    <Link
                        to="/buy"
                        className={`flex flex-col items-center text-xs ${location.pathname === "/buy"
                                ? "text-blue-600"
                                : "text-gray-500"
                            }`}
                    >
                    ...
                    <div className="w-full bg-white rounded-t-[35px] p-6 animate-in slide-in-from-bottom duration-200">
                        ...
                        <div className="flex flex-col space-y-4">
                            ...
                            {token && (
                                <button
                                    onClick={handleLogout}
                                    className="flex items-center gap-3 text-black text-left"
                                >
                        ...
                        <button
                            onClick={() => setProfileOpen(false)}
                            className="w-full mt-8 py-3 rounded-2xl bg-gray-100 text-gray-700 font-medium"
                        >
                            Close
                        </button>
                    </div>
